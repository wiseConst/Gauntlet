...
void GameLayer::OnAttach()
{
    ...
    // m_Font = io.Fonts->AddFontFromFileTTF("Resources/Fonts/OpenSans-Regular.ttf", 120.0f);
}
...
void GameLayer::OnUpdate(const float DeltaTime)
{
    ...
    if (m_Level.IsGameOver()) m_State = GameState::GameOver;
...
void GameLayer::OnEvent(Eclipse::Event& e)
{
    ...
    if (e.GetType() == EEventType::MouseButtonPressedEvent)
    {
