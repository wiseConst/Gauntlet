	...
	namespace Math
	{
		...
		*/
		...
		Mat3 Mat3::operator*(const Mat3& rhs) const
		{
			Mat3 tmp;
			for (int i = 0; i < 3; ++i) {
				tmp.rows[i].m_X = rows[i].m_X *
					rhs.rows[0].m_X + rows[i].m_Y *
					rhs.rows[1].m_X + rows[i].m_Z
					*
					rhs.rows[2].m_X;
				tmp.rows[i].m_Y = rows[i].m_X *
					rhs.rows[0].m_Y + rows[i].m_Y *
					rhs.rows[1].m_Y + rows[i].m_Z
					*
					rhs.rows[2].m_Y;
				tmp.rows[i].m_Z = rows[i].m_X *
					rhs.rows[0].m_Z + rows[i].m_Y *
					rhs.rows[1].m_Z + rows[i].m_Z
					*
					rhs.rows[2].m_Z;
			}
