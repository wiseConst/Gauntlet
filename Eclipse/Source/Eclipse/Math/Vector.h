...
class Vec2
{
  public:
    ...
    static FORCEINLINE float DotProduct(const Vec2& lhs, const Vec2& rhs) { return lhs.m_X * rhs.m_X + lhs.m_Y * rhs.m_Y; }

    static FORCEINLINE float CrossProduct(const Vec2& lhs, const Vec2& rhs) { return lhs.m_X * rhs.m_Y - lhs.m_Y * rhs.m_X; }
